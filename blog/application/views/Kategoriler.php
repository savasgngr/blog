          ...
          <div class="single_page">
			...
			<div class="single_post_content">
              ...
              <ul class="business_catgnav  wow fadeInDown">
                <li>
                  <figure class="bsbig_fig"> <a href="<?=base_url()?>Kategoriler/Kategori_goster/<?=$rs->id?>" class="featured_img"> 
				  <!-- Bura düzeltilecek -->
				  <img alt="" src="<?=base_url()?>images/featured_img1.jpg"> <span class="overlay"></span> </a>
                    <figcaption> <a href="<?=base_url()?>Kategoriler/Kategori_goster/<?=$rs->id?>"><?=$rs->aciklama?></a> </figcaption>
			...
			<div class="single_post_content_right">
			  ...
			  <?php foreach($altkat as $rs2){
					if($rs2->ust_id==$rs->id){?>
                <li>
                  <div class="media wow fadeInDown"> <a href="<?=base_url()?>Kategoriler/Kategori_goster/<?=$rs2->id?>" class="media-left"> 
				  <!-- Bura düzeltilecek -->
				  <img alt="" src="<?=base_url()?>images/post_img1.jpg"> </a>
                    <div class="media-body"> <a href="<?=base_url()?>Kategoriler/Kategori_goster/<?=$rs2->id?>" class="catg_title"> <?=$rs2->adi?></a> </div>
                  </div>
                </li>
				<?php }} ?>
    		 </ul>
