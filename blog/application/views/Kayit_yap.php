        ...
        <div class="left_content">
          <div class="single_page">
			<div class="single_post_content">
				...
				<br/><form action="<?=base_url()?>GirisCikis/Uye_kaydet" class="contact_form" enctype="multipart/form-data" method="post">
				  ...
				  <input class="form-control" name="sifre" type="text" placeholder="Şifre*" required>
				  <input class="form-control" name="sifre2" type="text" placeholder="Şifre Tekrar*" required>
				  ...
				  <input class="form-control" name="sehir" type="text" placeholder="Şehir*" required>
				  <textarea class="form-control" name="aciklama" cols="30" rows="10" placeholder="Hakkınızda birşeyler yazın...*"></textarea>
