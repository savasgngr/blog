												...
												<!--/candile-->
													<div class="candile"> 
															<div class="candile-inner">
																	<h3 class="sub-tittle">Kategori Listesi </h3>
																				   ...
																				   <table class="table table-striped table-bordered bootstrap-datatable datatable">
																					  ...
																					  ?>
																						<tr >
																							...
																							<td class="center">
																								<a class="btn blue four" href="<?=base_url()?>admin/Kategoriler/duzenle/<?=$rs->id?>">
																									<i class="fa fa-pencil"></i>  
																									Düzenle                                           
																								</a>
																								<a class="btn red six" href="<?=base_url()?>admin/Kategoriler/sil/<?=$rs->id?>" onclick="return confirm('silmek istediğinizden eminmisiniz ?');">
