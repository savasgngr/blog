        ...
        <div class="left_content">
          <div class="single_page">
			<div class="single_post_content">
				...
				<h4>Lütfen yazınızda yazım kurallarına dikkat ediniz.</h4>
				<br/><form action="<?=base_url()?>Home/Bize_gonder" class="contact_form" enctype="multipart/form-data" method="post">
				  <input class="form-control" name="adi" type="text" placeholder="Ad Soyad*" required>
				  <input class="form-control" name="email" type="email" placeholder="Email*" required>
				  <input class="form-control" name="tel" type="number" placeholder="Telefon"><br/></input>
				  <input class="form-control" name="baslik" type="text" placeholder="Mesajınızın Konusu*" required />
				  <textarea class="form-control" name="mesaj" cols="30" rows="10" placeholder="Mesajınızı yazın...*" required></textarea>
				  <input type="submit" value="Bize Gönderin">
				</form>
			  </div>
