          ...
          <div class="single_page">
			<div class="single_post_content">
				...
				<?php if ($this->session->userdata('oturum') !== NULL) {
							...
							if($yazi[0]->yazar_id!=$oturum['id']){redirect(base_url()."Home");}?>
							
				<form action="<?=base_url()?>Yazarlar/Yazi_guncelle/<?=$yazi[0]->id?>" class="contact_form" enctype="multipart/form-data" method="post">
